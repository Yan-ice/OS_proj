...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	62878793          	addi	a5,a5,1576 # c680 <uninit>
      60:	0000f697          	auipc	a3,0xf
      64:	d3068693          	addi	a3,a3,-720 # ed90 <buf>
    if(uninit[i] != '\0'){
...
0000000000000264 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     29c:	af8a0a13          	addi	s4,s4,-1288 # ed90 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
...
000000000000081a <writetest>:
{
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	4dc58593          	addi	a1,a1,1244 # ed90 <buf>
...
00000000000009aa <writebig>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	3ba90913          	addi	s2,s2,954 # ed90 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	36890913          	addi	s2,s2,872 # ed90 <buf>
  if(fd < 0){
...
0000000000000b60 <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	18c58593          	addi	a1,a1,396 # ed90 <buf>
     c0c:	8526                	mv	a0,s1
...
0000000000000d16 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	fb458593          	addi	a1,a1,-76 # ed90 <buf>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	752a8a93          	addi	s5,s5,1874 # 6830 <malloc+0xba8>
    10e6:	5a7d                	li	s4,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    1252:	42a68693          	addi	a3,a3,1066 # c678 <__global_pointer$+0x3910>
      big[i] = 'x';
    ...
    1268:	40078a23          	sb	zero,1044(a5) # c678 <__global_pointer$+0x3910>
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	60aa8a93          	addi	s5,s5,1546 # ed90 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	5ec70713          	addi	a4,a4,1516 # ed90 <buf>
    ...
    1806:	58eb0b13          	addi	s6,s6,1422 # ed90 <buf>
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f4a:	e4ab8b93          	addi	s7,s7,-438 # ed90 <buf>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002b6e0>
    pid = fork();
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    237a:	0007c603          	lbu	a2,0(a5) # ffffffffffffc000 <__BSS_END__+0xfffffffffffea260>
    237e:	85a6                	mv	a1,s1
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a4:	6705                	lui	a4,0x1
      *b = 99;
    26a6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3ffee260>
    for(b = a; b < a+TOOMUCH; b += 4096){
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2850:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63ee25f>
  a = sbrk(0);
    2854:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b4:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63ee25f>
...
0000000000002cde <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfe:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7ffee25f>
...
0000000000003210 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f4:	aa058593          	addi	a1,a1,-1376 # ed90 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    330a:	a8a74703          	lbu	a4,-1398(a4) # ed90 <buf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d4:	9c058593          	addi	a1,a1,-1600 # ed90 <buf>
...
000000000000412e <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4230:	b6458593          	addi	a1,a1,-1180 # ed90 <buf>
...
00000000000045e0 <sharedfd>:
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4730:	fd2783e3          	beq	a5,s2,46f6 <sharedfd+0x116>
      if(buf[i] == 'c')
    4734:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7ee260>
...
0000000000004798 <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    483a:	55aa0a13          	addi	s4,s4,1370 # ed90 <buf>
    483e:	0000aa97          	auipc	s5,0xa
    4842:	553a8a93          	addi	s5,s5,1363 # ed91 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4940:	45478793          	addi	a5,a5,1108 # ed90 <buf>
...
0000000000004d2e <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6e:	02690913          	addi	s2,s2,38 # ed90 <buf>
  for(i = 0; i < N; i++){
    4d72:	4a51                	li	s4,20
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4dcc:	fc890913          	addi	s2,s2,-56 # ed90 <buf>
  if(fd < 0){
...
0000000000004f0e <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4f5a:	e3aa0a13          	addi	s4,s4,-454 # ed90 <buf>
    name[0] = 'f';
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    base.s.ptr = freep = prevp = &base;
    5ce0:	0000c797          	auipc	a5,0xc
    5ce4:	0b078793          	addi	a5,a5,176 # 11d90 <base>
