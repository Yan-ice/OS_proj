...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	63078793          	addi	a5,a5,1584 # c688 <uninit>
      60:	0000f697          	auipc	a3,0xf
      64:	d3868693          	addi	a3,a3,-712 # ed98 <buf>
    if(uninit[i] != '\0'){
...
0000000000000264 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     298:	0000fa17          	auipc	s4,0xf
     29c:	b00a0a13          	addi	s4,s4,-1280 # ed98 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
...
000000000000081a <writetest>:
{
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b4:	0000e597          	auipc	a1,0xe
     8b8:	4e458593          	addi	a1,a1,1252 # ed98 <buf>
...
00000000000009aa <writebig>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
     9d4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
     9d6:	0000e917          	auipc	s2,0xe
     9da:	3c290913          	addi	s2,s2,962 # ed98 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  n = 0;
     a26:	4481                	li	s1,0
    i = read(fd, buf, BSIZE);
     a28:	0000e917          	auipc	s2,0xe
     a2c:	37090913          	addi	s2,s2,880 # ed98 <buf>
  if(fd < 0){
...
0000000000000b60 <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     c02:	660d                	lui	a2,0x3
     c04:	0000e597          	auipc	a1,0xe
     c08:	19458593          	addi	a1,a1,404 # ed98 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  if(buf[0] != 'h'){
     ...
     c20:	17c74703          	lbu	a4,380(a4) # ed98 <buf>
     c24:	06800793          	li	a5,104
     c28:	0af71b63          	bne	a4,a5,cde <unlinkread+0x17e>
  if(write(fd, buf, 10) != 10){
     c2c:	4629                	li	a2,10
     c2e:	0000e597          	auipc	a1,0xe
     c32:	16a58593          	addi	a1,a1,362 # ed98 <buf>
     c36:	8526                	mv	a0,s1
...
0000000000000d16 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     dda:	660d                	lui	a2,0x3
     ddc:	0000e597          	auipc	a1,0xe
     de0:	fbc58593          	addi	a1,a1,-68 # ed98 <buf>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10de:	00005a97          	auipc	s5,0x5
    10e2:	75aa8a93          	addi	s5,s5,1882 # 6838 <malloc+0xba8>
    10e6:	5a7d                	li	s4,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    10e8:	6991                	lui	s3,0x4
    10ea:	00114937          	lui	s2,0x114
    if(link("nosuchfile", (char*)p) != -1){
    10ee:	85a6                	mv	a1,s1
    10f0:	8556                	mv	a0,s5
    10f2:	00004097          	auipc	ra,0x4
    10f6:	7c0080e7          	jalr	1984(ra) # 58b2 <link>
    10fa:	01451f63          	bne	a0,s4,1118 <validatetest+0x52>
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    10fe:	94ce                	add	s1,s1,s3
    1100:	ff2497e3          	bne	s1,s2,10ee <validatetest+0x28>
}
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <__global_pointer$+0x35e0>
...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124e:	0000b697          	auipc	a3,0xb
    1252:	43268693          	addi	a3,a3,1074 # c680 <__global_pointer$+0x3910>
      big[i] = 'x';
    ...
    big[PGSIZE] = '\0';
    1264:	0000b797          	auipc	a5,0xb
    1268:	40078e23          	sb	zero,1052(a5) # c680 <__global_pointer$+0x3910>
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1786:	0000da97          	auipc	s5,0xd
    178a:	612a8a93          	addi	s5,s5,1554 # ed98 <buf>
      if(cc > sizeof(buf))
    ...
    17a0:	10a05263          	blez	a0,18a4 <pipe1+0x166>
      for(i = 0; i < n; i++){
    17a4:	0000d717          	auipc	a4,0xd
    17a8:	5f470713          	addi	a4,a4,1524 # ed98 <buf>
    ...
    for(n = 0; n < N; n++){
    1802:	0000db17          	auipc	s6,0xd
    1806:	596b0b13          	addi	s6,s6,1430 # ed98 <buf>
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f44:	4b79                	li	s6,30
          int cc = write(fd, buf, sz);
    1f46:	0000db97          	auipc	s7,0xd
    1f4a:	e52b8b93          	addi	s7,s7,-430 # ed98 <buf>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <__global_pointer$+0x35e0>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002b6d8>
    pid = fork();
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2376:	77f1                	lui	a5,0xffffc
    2378:	97ba                	add	a5,a5,a4
    237a:	0007c603          	lbu	a2,0(a5) # ffffffffffffc000 <__BSS_END__+0xfffffffffffea258>
    237e:	85a6                	mv	a1,s1
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    2464:	0327d513          	srli	a0,a5,0x32
    2468:	6791                	lui	a5,0x4
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a4:	6705                	lui	a4,0x1
      *b = 99;
    26a6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3ffee258>
    for(b = a; b < a+TOOMUCH; b += 4096){
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2850:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63ee257>
  a = sbrk(0);
    2854:	4501                	li	a0,0
...
0000000000002cde <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfe:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7ffee257>
...
0000000000003210 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f0:	0000c597          	auipc	a1,0xc
    32f4:	aa858593          	addi	a1,a1,-1368 # ed98 <buf>
    32f8:	00002097          	auipc	ra,0x2
    32fc:	572080e7          	jalr	1394(ra) # 586a <read>
  if(cc != 2 || buf[0] != 'f'){
    3300:	4789                	li	a5,2
    3302:	36f51863          	bne	a0,a5,3672 <subdir+0x462>
    3306:	0000c717          	auipc	a4,0xc
    330a:	a9274703          	lbu	a4,-1390(a4) # ed98 <buf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d0:	0000c597          	auipc	a1,0xc
    33d4:	9c858593          	addi	a1,a1,-1592 # ed98 <buf>
...
000000000000412e <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    422c:	0000b597          	auipc	a1,0xb
    4230:	b6c58593          	addi	a1,a1,-1172 # ed98 <buf>
...
00000000000045e0 <sharedfd>:
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4730:	fd2783e3          	beq	a5,s2,46f6 <sharedfd+0x116>
      if(buf[i] == 'c')
    4734:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7ee258>
...
0000000000004798 <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
    4836:	0000aa17          	auipc	s4,0xa
    483a:	562a0a13          	addi	s4,s4,1378 # ed98 <buf>
    483e:	0000aa97          	auipc	s5,0xa
    4842:	55ba8a93          	addi	s5,s5,1371 # ed99 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    488a:	0000a517          	auipc	a0,0xa
    488e:	50e50513          	addi	a0,a0,1294 # ed98 <buf>
    4892:	00001097          	auipc	ra,0x1
    4896:	dbc080e7          	jalr	-580(ra) # 564e <memset>
    489a:	44b1                	li	s1,12
        if((n = write(fd, buf, SZ)) != SZ){
    489c:	0000a997          	auipc	s3,0xa
    48a0:	4fc98993          	addi	s3,s3,1276 # ed98 <buf>
    ...
    493c:	0000a797          	auipc	a5,0xa
    4940:	45c78793          	addi	a5,a5,1116 # ed98 <buf>
...
0000000000004d2e <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    4d68:	4481                	li	s1,0
    memset(buf, i, SZ);
    4d6a:	0000a917          	auipc	s2,0xa
    4d6e:	02e90913          	addi	s2,s2,46 # ed98 <buf>
  for(i = 0; i < N; i++){
    4d72:	4a51                	li	s4,20
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    4dc6:	4481                	li	s1,0
    cc = read(fd, buf, SZ/2);
    4dc8:	0000a917          	auipc	s2,0xa
    4dcc:	fd090913          	addi	s2,s2,-48 # ed98 <buf>
  if(fd < 0){
...
0000000000004f0e <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4f56:	0000aa17          	auipc	s4,0xa
    4f5a:	e42a0a13          	addi	s4,s4,-446 # ed98 <buf>
    name[0] = 'f';
...
atoi(const char *s)
{
  ...
  while('0' <= *s && *s <= '9')
    5782:	0006c603          	lbu	a2,0(a3) # 4000 <forkforkfork+0x44>
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    base.s.ptr = freep = prevp = &base;
    5ce8:	0000c797          	auipc	a5,0xc
    5cec:	0b078793          	addi	a5,a5,176 # 11d98 <base>
